...
let services=[{title:"Design",text:"Diseño de interfaces con perspectiva UX/UI",num:0,svg:`<svg width="110" height="111" viewBox="0 0 110 111" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`},
{title:"Developing",text:"Desarrollo de proyectos e implementacion de ideas adaptadas a la web",num:1},
{title:"research",text:"Investigacion de mercado, diseño y metricas",num:2,svg:`<svg width="110" height="110" viewBox="0 0 110 110" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function createServices(service) {
    ...
    container.classList.add("cont-services","display-IF",`servicejs${service.num}`,"cont-serv-position")
    ...
    if (container.classList.contains("servicejs1")) {
...
if (width<=1000) {
    document.addEventListener("DOMContentLoaded",()=>{
        ...
        leftArrow.addEventListener("click",()=>{
            document.querySelector(`.servicejs${index}`).remove()
            if (index==0) {
            index=2
            }else{index--}
            createServices(services[index])
